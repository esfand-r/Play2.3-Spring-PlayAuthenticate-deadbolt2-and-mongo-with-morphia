 ...
 */
public class InvitationContentGenerator implements ITemplateContentGenerator {
    @Override
    public String renderContent(final NotificationType notificationType, final Map<String, String> parameters, final Class<?> templateClass) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        method = templateClass.getMethod("render", String.class, String.class);
        content = method.invoke(null, parameters.get("url"), parameters.get("name")).toString();
